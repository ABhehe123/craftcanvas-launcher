...
function copyShareLink() {
    navigator.clipboard.writeText("https://awake-games.itch.io/craftcanvas-modding-suite-minecraft");
...
async function openModDetails(projectId) {
    ...
    contentDiv.innerHTML = `
        ...
        <div style="text-align: center; margin-top: 40px; padding-top: 20px; border-top: 1px solid var(--border-color);">
            ...
            <iframe src="https://abhehe123.github.io/craftcanvas-launcher/ad-banner.html" width="728" height="90" frameborder="0" scrolling="no" style="border-radius: 8px; background: var(--bg-main);"></iframe>
        </div>
    `;
}
